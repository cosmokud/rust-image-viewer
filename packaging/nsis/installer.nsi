...
{{#if file_associations}}
; 7. File associations toggle page
...
Function PageFileAssociations
  ...
  !insertmacro MUI_HEADER_TEXT "File Associations" "Choose whether supported media files open with ${PRODUCTNAME}."

  ${NSD_CreateLabel} 0 0 100% 30u "This controls Open with and default association registration for supported image and video file types."
  Pop $1

  ${NSD_CreateCheckbox} 0 36u 100% 14u "Register ${PRODUCTNAME} for supported image and video file types"
  Pop $RegisterFileAssociationsCheckbox
  ${NSD_SetState} $RegisterFileAssociationsCheckbox $RegisterFileAssociationsState

  nsDialogs::Show
FunctionEnd

Function PageLeaveFileAssociations
  ${NSD_GetState} $RegisterFileAssociationsCheckbox $RegisterFileAssociationsState
FunctionEnd
{{/if}}
...
Function .onInit
  ...
  {{#if file_associations}}
  StrCpy $RegisterFileAssociationsState ${BST_CHECKED}
  {{/if}}
...
Section Install
  ...
  {{#if file_associations}}
  ${If} $RegisterFileAssociationsState == ${BST_CHECKED}
